% $Header: svn://172.19.32.13/trunk/AMIGO2R2016/Kernel/OPT_solvers/eSS/CeSS.m 770 2013-08-06 09:41:45Z attila $
...
%%%%%%%%%%%%JRB-Lukas -- With Matlab Parallel Computing Toolbox:  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		%Without parallel computing (useful for debugging):	
		else
